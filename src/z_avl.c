...
// #define Z__AVL_NULL 0

// Z_Avl_Node *z__avl_get_node(const Z_Avl_Tree *tree, size_t node_index)
// {
//     if (node_index == Z__AVL_NULL) {
//         return NULL;
//     }
...
// {
//     node->height = 1 + Z_MIN(z__avl_get_height(node->right), z__avl_get_height(node->left));
// }
...
// void z__avl_left_rotate(Z_Avl_Tree *tree, size_t root)
// {
